...
import {
  ...
  VIAJES_TRIP_DATA, VIAJES_FLIGHTS_DATA, VIAJES_ACCOMMODATIONS_DATA, VIAJES_DAY_NOTES_DATA,
  JAPAN_ITEMS_DATA
} from './data.js';
import {
...
export const SEED_SETS = {
  trips: TRIPS_DATA,
  activities: [...TRIP_DATA, ...BODA_TRIP_DATA, ...VIAJES_TRIP_DATA],
  flights: [...FLIGHTS_DATA, ...BODA_FLIGHTS_DATA, ...VIAJES_FLIGHTS_DATA],
  accommodations: [...ACCOMMODATIONS_DATA, ...BODA_ACCOMMODATIONS_DATA, ...VIAJES_ACCOMMODATIONS_DATA],
  tours: TOURS_DATA,
  dayNotes: [...DAY_NOTES_DATA, ...BODA_DAY_NOTES_DATA, ...VIAJES_DAY_NOTES_DATA],
